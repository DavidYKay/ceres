...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('pricing_weightunit', (
        ...
        db.send_create_signal('pricing', ['WeightUnit'])

        # Adding model 'Currency'
        db.create_table('pricing_currency', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=127)),
            ('symbol', self.gf('django.db.models.fields.CharField')(max_length=4)),
        ))
        db.send_create_signal('pricing', ['Currency'])

    def backwards(self, orm):
        # Deleting model 'WeightUnit'
        db.delete_table('pricing_weightunit')
    ...
    models = {
        ...
        'pricing.currency': {
            ...
            'symbol': ('django.db.models.fields.CharField', [], {'max_length': '4'})
        },
        'pricing.department': {
        ...
        'pricing.pricereport': {
            ...
            'price_type': ('django.db.models.fields.CharField', [], {'default': "'local'", 'max_length': '12'}),
